...
KERNEL_URL_BASE=${KERNEL_VERSION}
if [[ $KERNEL_VERSION = *.0 ]]; then
    KERNEL_URL_BASE=${KERNEL_VERSION::-2}
fi

VERSION_BASE_URL="https://kernel.ubuntu.com/~kernel-ppa/mainline/v${KERNEL_URL_BASE}/"
...
LINUX_HEADERS_URL="${VERSION_BASE_URL}amd64/linux-headers-${KERNEL_VERSION}-${KERNEL_VERSION_NUMERIC}_${KERNEL_VERSION}-${KERNEL_VERSION_NUMERIC}.${KERNEL_BUILD_DATE}_all.deb"
LINUX_HEADERS_GENERIC_URL="${VERSION_BASE_URL}amd64/linux-headers-${KERNEL_VERSION}-${KERNEL_VERSION_NUMERIC}-generic_${KERNEL_VERSION}-${KERNEL_VERSION_NUMERIC}.${KERNEL_BUILD_DATE}_amd64.deb"
LINUX_IMAGE_GENERIC_URL="${VERSION_BASE_URL}amd64/${KERNEL_IMAGE_FILENAME}"
LINUX_MODULES_GENERIC_URL="${VERSION_BASE_URL}amd64/linux-modules-${KERNEL_VERSION}-${KERNEL_VERSION_NUMERIC}-generic_${KERNEL_VERSION}-${KERNEL_VERSION_NUMERIC}.${KERNEL_BUILD_DATE}_amd64.deb"

# echo $LINUX_HEADERS_URL
# echo $LINUX_HEADERS_GENERIC_URL
# echo $LINUX_IMAGE_GENERIC_URL
# echo $LINUX_MODULES_GENERIC_URL
# exit
